...
const MESSAGES = {
	...
	depositApproved: 'Player deposit request approved by Agent {parentUsername}',
	withdrawalApproved: 'Player withdrawal request approved by Agent {parentUsername}',
	transferAdjustment: 'Transfer adjustment via Admin Site from House',
	transferCutoff: 'Cutoff Transfer via Agent Site from: {parentUsername}',
	transferFund: 'Fund Transfer via Agent Site from: {parentUsername}',
